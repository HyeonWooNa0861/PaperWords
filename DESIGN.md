...
- Trust signals: verified/local labels, restrained color, visible source relationships, stable typography and spacing
- Avoid: newspaper imitation, heavy serif dominance, multiple competing rail colors, loud AI gradients, ornamental glass, dense borders, oversized badges, or visual cues that imply runtime network enrichment
...
- Color is semantic and scarce: blue means action/link/focus; warm warning color is reserved for error states.
...
- Color: cool canvas `#f5f5f7`, elevated white, primary ink `#1d1d1f`, AA-safe secondary `#66666b`, separator `rgba(0,0,0,.08)`, interaction blue `#0071e3`, pale blue selection, pale amber for error semantics
...
- Layout adaptations: two-column Today/detail grids collapse to one column; sticky evidence rails become normal flow; topic grids become one column; search buttons become full width on compact screens
